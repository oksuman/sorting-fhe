...
template <size_t N>
class KWay2SortTest : public ::testing::Test {
  protected:
    void SetUp() override {
...
template <typename T>
class KWay2SortTestFixture : public KWay2SortTest<T::value> {};

TYPED_TEST_SUITE_P(KWay2SortTestFixture);

TYPED_TEST_P(KWay2SortTestFixture, SortTest) {
    ...
    auto Cfg =
        SignConfig(CompositeSignConfig(3, d_f, d_g), this->m_multDepth);
...
REGISTER_TYPED_TEST_SUITE_P(KWay2SortTestFixture, SortTest);
